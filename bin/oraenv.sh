#!/usr/bin/sh
#
# $Header: buildtools/scripts/oraenv.sh /linuxamd64/7 2020/02/28 11:58:53 josepe Exp $ oraenv.sh.pp Copyr (c) 1991 Oracle
# 
# Copyright (c) 1991, 2020, Oracle and/or its affiliates. All rights reserved.
#
...
if [ -r $ORACLE_HOME/install/orabasetab -o -r $ORACLE_HOME/inventory/ContentsXML/oraclehomeproperties.xml ]; then
